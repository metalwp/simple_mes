...
urlpatterns = [
    path('station_index/', views.IndexView.as_view(), name='station_index'),
    ...
    path('fixture_teststandard/<int:fixture_id>/uploadData/', views.uploadTestStandard, name='uploadTestStandard'),
